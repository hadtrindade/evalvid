...
SHFLAGS=-shared -Wl,--output-def,$(@:.dll=.def),--out-implib,lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc
...
TARGET_MMX=yes
SRC_PATH="/d/cvs/gpac_extra_libs/ffmpeg"
SRC_PATH_BARE=/d/cvs/gpac_extra_libs/ffmpeg
BUILD_ROOT="/d/cvs/gpac_extra_libs/ffmpeg"
