        ...
        uint8_t *buf, int buf_size)
{
    ...
    {
#ifdef CONFIG_MSVC
		int32_t *predictors = (int32_t *)_alloca(s->channels*sizeof(int32_t));
        TTAFilter *filters=(TTAFilter *)_alloca(s->channels*sizeof(TTAFilter));
        TTARice *rices=(TTAFilter *)_alloca(s->channels*sizeof(TTAFilter ));
#else
