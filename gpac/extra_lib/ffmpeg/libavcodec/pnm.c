...
static enum PixelFormat pgm_pf[3]={PIX_FMT_GRAY8, PIX_FMT_GRAY16BE, -1};
...
static enum PixelFormat pgmyuv[2]={PIX_FMT_YUV420P, -1};
...
static enum PixelFormat ppm_pf[2]={PIX_FMT_RGB24, -1};
AVCodec ppm_encoder = {
    "ppm",
    CODEC_TYPE_VIDEO,
    CODEC_ID_PPM,
...
static enum PixelFormat pbm_pf[2]={PIX_FMT_MONOWHITE, -1};
AVCodec pbm_encoder = {
    "pbm",
    CODEC_TYPE_VIDEO,
    CODEC_ID_PBM,
...
static enum PixelFormat pam_pf[]={PIX_FMT_RGB24, PIX_FMT_RGBA32, PIX_FMT_GRAY8, PIX_FMT_MONOWHITE, -1};
AVCodec pam_encoder = {
    "pam",
    CODEC_TYPE_VIDEO,
    CODEC_ID_PAM,
