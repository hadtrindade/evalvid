...
/*ugly hack*/
#elif defined(CONFIG_MSVC) || defined(__SYMBIAN32__) 
static inline uint16_t unaligned16(const void *v) {         \
	char c[4]; c[0] = ((char *)v)[0];  c[1] = ((char *)v)[1]; return *(const uint16_t *) c;	\
}	\
static inline uint32_t unaligned32(const void *v) {         \
	char c[4]; c[0] = ((char *)v)[0];  c[1] = ((char *)v)[1]; c[2] = ((char *)v)[2]; c[3] = ((char *)v)[3]; return *(const uint32_t *) c;	\
}	\
