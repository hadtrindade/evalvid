...
static int find_frame_rate_index(MpegEncContext *s){
    ...
    for(i=1;i<14;i++) {
        int64_t n0= INT64_C(1001)/ff_frame_rate_tab[i].den*ff_frame_rate_tab[i].num*s->avctx->time_base.num;
        int64_t n1= INT64_C(1001)*s->avctx->time_base.den;
...
#ifdef CONFIG_ENCODERS
static enum PixelFormat mpg1_pf[2]={PIX_FMT_YUV420P, -1};
...
static enum PixelFormat mpg2_pf[3]={PIX_FMT_YUV420P, PIX_FMT_YUV422P, -1};
